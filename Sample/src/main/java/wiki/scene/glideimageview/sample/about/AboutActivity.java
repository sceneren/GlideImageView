package wiki.scene.glideimageview.sample.about;
...
import wiki.scene.glideimageview.sample.BaseActivity;
import com.sunfusheng.glideimageview.sample.R;
import wiki.scene.glideimageview.sample.util.AppUtil;
