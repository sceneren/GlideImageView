package wiki.scene.glideimageview.sample.image;
...
import wiki.scene.glideimageview.sample.util.ColorUtil;
import wiki.scene.glideimageview.sample.util.StatusBarUtil;
